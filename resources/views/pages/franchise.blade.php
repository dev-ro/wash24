...
@section('title') Franchise Enquiry @endsection
@section('body')     
            ...
            <div class="col-lg-8">
                <div class="body">
                    <div class="description-first">
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="title">Get Started With {{config('app.name')}} Franchise.</h2>
                                <p>At {{config('app.name')}}, we are giving the opportunity to take the franchise for multi home care franchise like, Doorstep Car Wash Franchise, Painter On Call, Disinfectants Services, Vehicle Leasing, Pest Control.</p>
                        ...
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="card">
                                ...
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                    <div class="card-body bg-light px-4 py-2">
                                        <p>Process of apply is very simple in franchise. You can call us on +91-8002888900 or you can directly fill the franchise form.
        ...
        <div id="applyFranchiseForm" class="row mt-5 bg-light">
            <div class="col-lg-8 m-auto">
                <div class="form">
                    ...
                    <form action="{{route('franchise.enq.form')}}" method="POST">
                        @csrf
                        <div class="row">
                           <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-element">
                                            <input name="firstname" type="text" placeholder="Your last name">
                                        </div>
                                    </div>
                                </div>
                           </div>
